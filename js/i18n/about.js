...
(function () {
    ...
    const about = {
        about: {
            ...
            values: {
                ...
                trust: {
                    id: 'Kami membangun kepercayaan melalui komitmen yang konsisten dan dapat diandalkan dalam setiap kemitraan.',
                    en: 'We build trust through consistent and reliable commitment in every partnership.'
                },
                ingenuity: {
                    id: 'Kami mengedepankan kecerdikan dalam menciptakan solusi inovatif berbasis ilmu pengetahuan.',
                    en: 'We champion ingenuity in creating innovative, science-based solutions.'
                },
                communication: {
                    id: 'Komunikasi yang terbuka dan kolaboratif adalah kunci sinergi yang efektif dalam tim kami.',
                    en: 'Open and collaborative communication is the key to effective synergy in our team.'
                },
                diversity: {
                ...
                partnership: {
                    ...
                    en: 'We collaborate across sectors to maximize impact and achieve common goals.'
                },
                protecting: {
                    id: 'Komitmen kuat untuk melindungi lingkungan dan sumber daya alam sebagai warisan generasi mendatang.',
                    en: 'A strong commitment to protecting the environment and natural resources as a legacy for future generations.'
                },
                performance: {
                    id: 'Kami berfokus pada hasil, efisiensi, dan kualitas sebagai cerminan dedikasi terhadap keberlanjutan.',
                    en: 'We focus on results, efficiency, and quality as a reflection of our dedication to sustainability.'
                }
            },
            team: {
                ...
                coordinators: { id: 'Koordinator Program', en: 'Programme Coordinators' },
                staff: { id: 'Staf', en: 'Staff' }
            },
            teamDetail: {
                backToTeam: { id: 'Kembali ke Tim IREEM', en: 'Back to IREEM Team' },
                backToTeamBtn: { id: 'Kembali ke Tim', en: 'Back to Team' },
                loading: { id: 'Memuat profil...', en: 'Loading profile...' },
                notFoundTitle: { id: 'Profil Tidak Ditemukan', en: 'Profile Not Found' },
                notFoundMessage: { id: 'Maaf, profil yang Anda cari tidak tersedia.', en: 'Sorry, the profile you are looking for is not available.' },
                biographyLabel: { id: 'Biografi', en: 'Biography' },
                expertiseLabel: { id: 'Keahlian', en: 'Expertise' },
                experienceLabel: { id: 'Pengalaman', en: 'Experience' },
                educationLabel: { id: 'Pendidikan', en: 'Education' },
                contactLabel: { id: 'Kontak', en: 'Contact' }
            }
        }
    };
    ...
    if (window.i18n && window.i18n.registerTranslations) {
        window.i18n.registerTranslations(about);
    }
